<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<%@page import="com.xintian.mall.image.ImageUtils" %>
...
<div id="filterPage">
    <!-- 公用头部导航 -->
    <%@include file="/v2/common/top.jsp" %>
    <!-- 用于取出 搜索关键字 -->
                        ...
                        <div class="wbox">
                            <div class="pro-img">
                                <s:a action="product_select" namespace="/product">
                                    ...
                                    <s:set name="ip" value= "goodsImageAddress"/>
                                    <img width="100" height="100"
                                         src="<%= ImageUtils.getImageUrl("<s:property value=\"#ip\" />") %>"
                                         <%--<s:property value="goodsImageAddress"></s:property>--%>

                                         alt="<s:property value="name" />">
                                    <s:property value="ip"></s:property>
                                </s:a>
                            </div>
                            <div class="pro-info">
                                <p class="pro-name">
    ...
    <!-- 公用尾部 -->
    <%@include file="/v2/common/bottom.jsp" %>
</div>
</body>
</html>