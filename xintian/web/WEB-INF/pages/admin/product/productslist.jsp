...
<html>
 ...
 <td background="./images/tablebg.jpg">产品名称 </td> <td background="./images/tablebg.jpg">图片</td><td background="./images/tablebg.jpg">大类</td><td background="./images/tablebg.jpg">小类</td> <td background="./images/tablebg.jpg">价格</td><td colspan="2" align="center" background="./images/tablebg.jpg">操作</td></tr>   
            ...
            <td>
            <img src="images/<s:property value="pic"/>" width="100" height="100"/> 
            </td>
             <td>
        ...
        <s:else>
            <a href="productsAction!list?page=1">第一页</a>
            <a href="productsAction!list?page=<s:property value="%{pageBean.currentPage-1}"/>">上一页</a>
        </s:else>
        <s:if test="%{pageBean.currentPage != pageBean.totalPages}">
            <a href="productsAction!list?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a>
            <a href="productsAction!list?page=<s:property value="pageBean.totalPages"/>">最后一页</a>
        </s:if>
        <s:else>
            下一页 最后一页
        </s:else>   
